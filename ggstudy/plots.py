...
outdir         = os.path.join(config['outputDir'], str(energy),'plots/ggstudy/'',config_jj['outputDir_sub'], 'H{}{}'.format(args.flavor.lower(), args.flavor.lower()))
inputDir       = os.path.join(config['outputDir'], str(energy),'histmaker/ggstudy/'', config_jj['outputDir_sub'], 'H{}{}'.format(args.flavor.lower(), args.flavor.lower()))
print(outdir)
print(inputDir)
...
hists["cutFlow"] = {
    ...
    "xtitle":   ["All events", "photon isolation from treemaker","lepton veto","photon momentum", "cos theta","particle n cut",  "tagger score cut", "mjj cut", "m recoil loose","m recoil tight"], 
    "ytitle":   "Events ",
}
