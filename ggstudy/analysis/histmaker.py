...
if args.config == 160:
    config = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_160.yaml")
    config_jj = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_jj_160.yaml")
elif args.config == 240:
    config = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_240.yaml")
    config_jj = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_jj_240.yaml")
elif args.config == 365:
    config = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_365.yaml")
    config_jj = load_config("/afs/cern.ch/work/l/lherrman/private/HiggsGamma/analysis/ggstudy/FCCAnalyses/ggstudy/config/config_jj_365.yaml")
...
includePaths = ["functions.h", "jetcharge.h"]
...
outputDir   =  os.path.join(config['outputDir'], str(ecm),'histmaker/ggstudy/', config_jj['outputDir_sub'], 'H{}{}'.format(args.flavor.lower(), args.flavor.lower()))
print(outputDir)
...
inputDir   =  os.path.join(config['outputDir'], str(ecm),'treemaker/ggstudy/', config_jj['outputDir_sub'], 'H{}{}'.format(args.flavor.lower(), args.flavor.lower()))
...
def build_graph(df, dataset):
   ...
   # results.append(df.Histo1D(("m_cut_after", "",  100, 0, 100), "m_cut"))
    ...
    if do_inference:
        ...
        BDTName = os.path.join(config['outputDir'], str(ecm),'treemaker/ggstudy/', config_jj['outputDir_sub'], 'H{}{}'.format(args.flavor.lower(), args.flavor.lower()), '{}.root'.format(bdt_name))
